      ...
      try {
        ...
        resultCont.innerHTML = `
          <div class="result-grid">
            <div class="result-item"><span>Valid:</span> ${
              data.format_valid ? "Yes" : "No"
            }</div>
            <div class="result-item"><span>Deliverable:</span> ${
              data.state === "deliverable" ? "Yes" : "No"
            }</div>
          </div>`;
      } catch (error) {
        console.error("Error:", error);
        resultCont.innerHTML =
          '<div class="result-item error">Error: Unable to validate email.</div>';
      } finally {
